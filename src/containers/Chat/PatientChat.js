...
const PatientChat = () => {
  ...
  const { loadMore, deleteMessage } = useChatMessages({
    user: patient,
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div
        className="container py-3 px-1 px-md-3 flex-grow-1"
        style={{ minHeight: 0 }}
      >
        <div className="row g-3 flex-grow-1" style={{ minHeight: 0 }}>
          ...
          <div className="col-12 col-md-4 col-lg-3">
            <div className="card h-100 shadow-sm">
              <div className="card-header d-flex justify-content-between align-items-center custom-bg-light">
                <h5 className="mb-4" style={{ fontSize: 18 }}>
                  Danh sách bác sĩ
                </h5>
                {isLoggedInPatient ? (
                  <button
              ...
              <div
                className="card-body p-2 overflow-auto flex-grow-1"
                style={{ minHeight: 0 }}
              >
                {allDoctors.length === 0 ? (
          ...
          <div className="col-12 col-md-8 col-lg-9 d-flex flex-column">
            <div className="card flex-grow-1 shadow-sm d-flex flex-column card-custom-height">
              <div
                className="card-body d-flex flex-column p-0 flex-grow-1"
                style={{ minHeight: 0 }}
              >
                {!selectedDoctor ? (
                  <div className="d-flex align-items-center justify-content-center h-100">
                    <p className="text-muted">
                      Vui lòng chọn một bác sĩ để bắt đầu chat
                    </p>
                  </div>
                ) : (
                  <>
                    <div className="d-flex align-items-center gap-3 border-bottom px-3 py-2 custom-bg-light">
                      ...
                      <div>
                        ...
                        <div className="text-muted small">
                          {selectedDoctor.positionData?.valueVi || "Bác sĩ"}
                        </div>
