      ...
      <React.Fragment>
        ...
        <div className="detail-doctor-container">
          <div className="intro-doctor">
            ...
            style={
                {
                backgroundImage: `url(${detailDoctorbyId && detailDoctorbyId.image ? detailDoctorbyId.image : ""})`,
          ...
          {detailDoctorbyId && detailDoctorbyId.Markdown && detailDoctorbyId.Markdown.contentHTML
                &&
                <div dangerouslySetInnerHTML={{__html: detailDoctorbyId.Markdown.contentHTML}}>
