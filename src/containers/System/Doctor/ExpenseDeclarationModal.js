...
import "./ExpenseDeclarationModal.scss";
...
class ExpenseDeclarationModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fullName: "",
  ...
  handleConfirmBooking = async () => {
    ...
    if (res && res.errCode === 0) {
      ...
      this.props.closeExpenseDeclarationModal();
    } else {
      toast.error("Booking a new appointment error!");
    }
  };
  render() {
    let { isOpenModalBooking, closeExpenseDeclarationModal, dataTime } =
      this.props;
    let doctorId = "";
    if (dataTime && !_.isEmpty(dataTime)) {
          ...
          <div className="modal-booking-header">
            ...
            <span className="right">
              <i
                ...
                onClick={closeExpenseDeclarationModal}
              ></i>
            </span>
          </div>
